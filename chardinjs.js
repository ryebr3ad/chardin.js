...
(function() {
  ...
  (function($, window) {
    ...
    chardinJs = (function() {
      ...
      chardinJs.prototype._get_class = function(element) {
        return element.getAttribute('data-class') || '';
      };

      chardinJs.prototype._place_tooltip = function(element) {
        var data_class, my_height, my_width, target_element_position, target_height, target_width, tooltip_layer, tooltip_layer_position;
        ...
        data_class = this._get_class(element);
        if (data_class === '') {
      ...
      chardinJs.prototype._show_element = function(element) {
        ...
        tooltip_layer.className = "chardinjs-tooltip chardinjs-" + (this._get_position(element)) + " " + (this._get_class(element));
